...
Usage:
    python scripts/run_league.py                    # Run with defaults (4 agents, 3 rounds)
    python scripts/run_league.py --num-agents 6     # Run with 6 agents
    python scripts/run_league.py --rounds 5         # Run 5 rounds per matchup
    python scripts/run_league.py --log-level DEBUG  # Verbose logging
